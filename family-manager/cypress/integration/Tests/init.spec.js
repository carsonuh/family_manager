...
//     //     cy.get('[title="Add Event"]').click();
//     //     cy.get('.MuiDialogContent-root > :nth-child(1) > .MuiFormControl-root > .MuiInputBase-root > .MuiInputBase-input').type("Cool Event")

//     //     cy.get('[data-testid=startDateInput]').click()
//     //     cy.get(':nth-child(5) > :nth-child(5) > .MuiButtonBase-root').click().type("{enter}")
//     //     cy.get('[data-testid=endDateInput]').click()
//     //     cy.get(':nth-child(5) > :nth-child(5) > .MuiButtonBase-root').click().type("{enter}")

//     // cy.get(':nth-child(3) > :nth-child(2) > .MuiInputBase-root > .MuiInputBase-input').click()

//     // cy.get('.MuiPickersClock-squareMask > :nth-child(5').click()

//     // cy.get(':nth-child(3) > :nth-child(2) > .MuiInputBase-root > .MuiInputBase-input').type("02:00 AM");
